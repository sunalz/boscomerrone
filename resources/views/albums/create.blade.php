...
@section('content')
    ...
    <div class="col-md-3 float-left"></div>
      ...
      {!!form::open(['action' => 'AlbumsController@store','method' => 'POST','class' =>'form-control', 'id' =>'form' , 'enctype' => 'multipart/form-data'])!!}
        ...
        {{Form::submit('Crea Album',['id' =>'submit',  'class'=>'btn btn-primary btn-block'])}}
