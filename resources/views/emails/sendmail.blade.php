...
<table border="0" cellspacing="0" cellpadding="0" class="table_width_100" width="100%" style="max-width: 680px; min-width: 300px;">
	...
	<tr><td align="center" bgcolor="#fbfcfd">
		<table width="90%" border="0" cellspacing="0" cellpadding="0">
            ...
            <h3>Join Request by: {{$email}}</h3>
					<span style="font-family: Arial, Helvetica, sans-serif; font-size: 34px; color: #57697e;">
						<p class="text-capitalize" style="text-transform: capitalize;">Event Name : {{$event}}</p>
					</span></font>
				</div>
			...
			<tr><td align="center">
				<div style="line-height: 24px;">
					...
					Event Description: <br> {{$description}}
					</span></font>
				</div>
				<!-- padding --><div style="height: 40px; line-height: 40px; font-size: 10px;"></div>
			</td></tr>
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr><td align="center" style="padding:20px;flaot:left;width:100%; text-align:center;">
				...
				<span style="font-family: Arial, Helvetica, sans-serif; font-size: 13px; color: #96a5b5;">
					2017 © BoscoMerrone. ALL Rights Reserved.
				</span></font>
			</td></tr>
		</table>
